...
def SetupArgs():
    return [
        ...
        ['fatjet1Pt',40,0,1000,'p_{T} [GeV]','Events/1.0'],
        ['fatjet1PtSmearedCentral',40,0,1000,'p_{T} [GeV]','Events/1.0'],
        ['fatjet1PtSmearedUp',40,0,1000,'p_{T} [GeV]','Events/1.0'],
        ['fatjet1PtSmearedDown',40,0,1000,'p_{T} [GeV]','Events/1.0'],
        ...
        ['dilepPt',40,0,1000,'p_{T,ll} [GeV]','Events/1.0'],
        ['pho1Pt',40,0,1000,'p_{T,ll} [GeV]','Events/1.0'],
