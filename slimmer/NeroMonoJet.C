#define NeroMonoJet_cxx
#include "NeroMonoJet.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void NeroMonoJet::Loop()
{
//   In a ROOT session, you can do:
//      root> .L NeroMonoJet.C
//      root> NeroMonoJet t
...
NeroMonoJet::NeroMonoJet(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://eoscms.cern.ch//store/group/phys_exotica/monojet/zdemirag/setup80x/Nero/zey_base/GJets_HT-400To600_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/GJets_HT-400To600/160709_172352/0000/NeroNtuples_8.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://eoscms.cern.ch//store/group/phys_exotica/monojet/zdemirag/setup80x/Nero/zey_base/GJets_HT-400To600_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/GJets_HT-400To600/160709_172352/0000/NeroNtuples_8.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("root://eoscms.cern.ch//store/group/phys_exotica/monojet/zdemirag/setup80x/Nero/zey_base/GJets_HT-400To600_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/GJets_HT-400To600/160709_172352/0000/NeroNtuples_8.root:/nero");
...
NeroMonoJet::~NeroMonoJet()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t NeroMonoJet::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t NeroMonoJet::LoadTree(Long64_t entry)
{
...
void NeroMonoJet::Init(TTree *tree)
{
...
void NeroMonoJet::Show(Long64_t entry)
{
...
Int_t NeroMonoJet::Cut(Long64_t entry)
{
